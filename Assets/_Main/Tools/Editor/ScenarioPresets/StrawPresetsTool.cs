...
{
    public class StrawPresetsTool : CustomToolWindow
    {
        protected string[] folders = new string[] { "Assets/_Main/Configuration/StrawPresets" };
        protected string saveFolder => folders[0];
        protected string colorName = "StrawPresets";
